...
/**
 * Enhanced Fibonacci Sequence Generator in TypeScript
 */
 ...
 */
function generateFibonacci(termCount: number, showStats: boolean, columnMode: boolean): void {
    t1 = 0n;
    t2 = 1n;
    sum = 0n;
 ...
 */
function generateUpToMax(maxVal: bigint): void {
    t1 = 0n;
    t2 = 1n;
    let count = 0;
    let output = '';
 ...
 */
function parseBigIntSafe(input: string): bigint | null {
    try {
